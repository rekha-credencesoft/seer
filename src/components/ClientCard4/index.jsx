    ...
    <div className={`${ClientCard}  md:h-[400px]  sm:h-[300px]  p-10 `}>
      <div className="flex items-center justify-center ">
        ...
        <div className="ClientCardContent mt-8 ">
            ...
            <p style={{fontFamily:'Roboto, sans-serif'}}className='text-center text-[#000000] '>"Our stores were swamped with web returns. Sapiensv2 swiftly and elegantly enabled us to re-distribute the returns to locations with the greatest sales potential."</p>
