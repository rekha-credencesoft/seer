...
const MeetTheTeam = () => {
  const details = [
    ...
    },
    {
      ...
      designation: "Founder",
      description:
        "A chartered accountant by qualification, Damien brings more than 35 years of retail technology experience to Sapiensv2, specialising in Data Design, Analytics, and Data Visualization. Damien's focus at Sapiensv2 is Data Development, and he is a key contributor to product strategy and design.",
    },
  ];
  return (
    <div className="pb-16">
